package com.example.dell.alarmapp.Alarm.view;
        ...
        public void onChanged() {
            ...
            if(adapter != null && mEmptyView != null) {
                if(adapter.getItemCount() == 0) {
                    ...
                    com.example.dell.alarmapp.Alarm.view.EmptyRecyclerView.this.setVisibility(View.GONE);
                }
                else {
                    mEmptyView.setVisibility(View.GONE);
                    com.example.dell.alarmapp.Alarm.view.EmptyRecyclerView.this.setVisibility(View.VISIBLE);
