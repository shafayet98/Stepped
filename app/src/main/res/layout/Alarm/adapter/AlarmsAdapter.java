package com.example.dell.alarmapp.Alarm.adapter;
...
public final class AlarmsAdapter extends RecyclerView.Adapter<AlarmsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        final com.example.dell.alarmapp.Alarm.model.Alarm alarm = mAlarms.get(position);

        holder.time.setText(com.example.dell.alarmapp.Alarm.util.AlarmUtils.getReadableTime(alarm.getTime()));
        holder.amPm.setText(com.example.dell.alarmapp.Alarm.util.AlarmUtils.getAmPm(alarm.getTime()));
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Intent launchEditAlarmIntent =
                        com.example.dell.alarmapp.Alarm.ui.AddEditAlarmActivity.buildAddEditAlarmActivityIntent(
                                c, com.example.dell.alarmapp.Alarm.ui.AddEditAlarmActivity.EDIT_ALARM
                        );
                launchEditAlarmIntent.putExtra(com.example.dell.alarmapp.Alarm.ui.AddEditAlarmActivity.ALARM_EXTRA, alarm);
    ...
    private Spannable buildSelectedDays(com.example.dell.alarmapp.Alarm.model.Alarm alarm) {
