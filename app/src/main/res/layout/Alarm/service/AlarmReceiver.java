...
import com.example.dell.alarmapp.Alarm.ui.AlarmLandingPageActivity;
...
public final class AlarmReceiver extends BroadcastReceiver {
    ...
    private static final String TAG = com.example.dell.alarmapp.Alarm.service.AlarmReceiver.class.getSimpleName();
    ...
    public static void setReminderAlarm(Context context, Alarm alarm) {
        ...
        final Intent intent = new Intent(context, com.example.dell.alarmapp.Alarm.service.AlarmReceiver.class);
