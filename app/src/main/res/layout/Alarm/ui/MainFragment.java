...
import com.example.dell.alarmapp.Alarm.adapter.AlarmsAdapter;
import com.example.dell.alarmapp.Alarm.model.Alarm;
import com.example.dell.alarmapp.Alarm.service.LoadAlarmsReceiver;
import com.example.dell.alarmapp.Alarm.service.LoadAlarmsService;
import com.example.dell.alarmapp.Alarm.util.AlarmUtils;
import com.example.dell.alarmapp.Alarm.view.EmptyRecyclerView;
...
public final class MainFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rv.addItemDecoration(new com.example.dell.alarmapp.Alarm.view.DividerItemDecoration(getContext()));
