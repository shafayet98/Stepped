package com.example.dell.alarmapp.Alarm.model;
...
public final class Alarm implements Parcelable{
    ...
    public static final Creator<Alarm> CREATOR = new Creator<Alarm>() {
        @Override
        public com.example.dell.alarmapp.Alarm.model.Alarm createFromParcel(Parcel in) {
            return new com.example.dell.alarmapp.Alarm.model.Alarm(in);
        }

        @Override
        public com.example.dell.alarmapp.Alarm.model.Alarm[] newArray(int size) {
            return new com.example.dell.alarmapp.Alarm.model.Alarm[size];
        }
    };
