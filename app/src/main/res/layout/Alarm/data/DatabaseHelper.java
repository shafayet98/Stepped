package com.example.dell.alarmapp.Alarm.data;
...
import com.example.dell.alarmapp.Alarm.util.AlarmUtils;
...
public final class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static com.example.dell.alarmapp.Alarm.data.DatabaseHelper sInstance = null;

    public static synchronized com.example.dell.alarmapp.Alarm.data.DatabaseHelper getInstance(Context context) {
        if (sInstance == null) {
            sInstance = new com.example.dell.alarmapp.Alarm.data.DatabaseHelper(context.getApplicationContext());
        }
        return sInstance;
    }
